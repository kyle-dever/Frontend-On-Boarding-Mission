<template>
    <div>
        <b-navbar toggleable="lg" type="dark" variant="info" fixed="top" sticky="true">
            <b-navbar-brand href="/">DEVER's Developer Blog</b-navbar-brand>
            <b-navbar-toggle target="nav-collapse"></b-navbar-toggle>

            <b-collapse id="nav-collapse" is-nav>
                <b-navbar-nav>
                    <b-nav-item href="/board/machine">머신러닝</b-nav-item>
                    <b-nav-item href="/board/data">데이터분석</b-nav-item>
                    <b-nav-item href="/board/program">프로그래밍</b-nav-item>
                </b-navbar-nav>

                <!-- Right aligned nav items -->
                <b-navbar-nav class="ml-auto">
                    <b-nav-item href="#" @click="handleLogin">{{ loginText }}</b-nav-item>
                    <b-nav-item href="#" @click="signIn" v-if="!loginStore.isLogin">회원가입</b-nav-item>
